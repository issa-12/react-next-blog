    ...
    return (
        <div className='py-5 px-5 md:px:12 lg:px-28'>
            ...
            <div className='text-center my-8'>
                ...
                <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-bas'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas risus, nec viverra mi. Sed cursus metus vitae nisi varius, a blandit lectus ornare.
                </p>
                <form onSubmit={onSubmitHandler} className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black shadow-[-7px_7px_0px_#000000]' action="">
                    <input onChange={(e) => setEmail(e.target.value)} value={email} type="email" placeholder='Enter you email' className='pl-4 outline-none' />
